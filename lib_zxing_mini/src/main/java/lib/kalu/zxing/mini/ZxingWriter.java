...
import lib.kalu.zxing.mini.exception.WriterException;
import lib.kalu.zxing.mini.qrcode.QRCodeWriter;
import lib.kalu.zxing.mini.qrcode.decoder.ErrorCorrectionLevel;
import lib.kalu.zxing.mini.qrcode.encoder.ByteMatrix;
import lib.kalu.zxing.mini.qrcode.encoder.Encoder;
import lib.kalu.zxing.mini.qrcode.encoder.QRCode;
 ...
 */
public final class ZxingWriter extends QRCodeWriter {
...
//        LogUtil.log("QrcodePlusWriter =>");
    ...
    private static class Holder {
        private static final ZxingWriter qrcodePlusWriter = new ZxingWriter();
    }

    public static final ZxingWriter getQrcodePlusWriter() {
        return Holder.qrcodePlusWriter;
    }
