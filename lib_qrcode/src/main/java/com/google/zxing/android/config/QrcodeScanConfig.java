package com.google.zxing.android.config;
 ...
 */
@Keep
public class QrcodeScanConfig implements Serializable {
    ...
    private QrcodeScanConfig() {

    }


    private QrcodeScanConfig(Builder builder) {
    ...
    public final static class Builder {
        ...
        public QrcodeScanConfig builder() {
            return new QrcodeScanConfig(this);
        }
