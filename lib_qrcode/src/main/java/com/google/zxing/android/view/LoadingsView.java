package com.google.zxing.android.view;
 ...
 */
public class LoadingsView extends View {

    private static final String TAG = LoadingsView.class.getSimpleName();
     ...
     */
    public LoadingsView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * The constructor for the ProgressWheel
     */
    public LoadingsView(Context context) {
        super(context);
        setAnimationEnabled();
    }
