...
//        int rectW = (int) (14 * 4 + 0.5f);
        ...
        float displacement;
        try {
            CharSequence hint = (null == getTag(R.id.moudle_zbar_id_finderview_tag) ? null : getTag(R.id.moudle_zbar_id_finderview_tag).toString());
            ...
            setTag(R.id.moudle_zbar_id_finderview_tag, String.valueOf(parseFloat < 0 ? -displacement : displacement));

        } catch (Exception e) {
            displacement = (mType == 1 ? 2f : 5f);
            setTag(R.id.moudle_zbar_id_finderview_tag, String.valueOf(displacement));
        }
        ...
        // 下移
        if (null == getTag(R.id.moudle_zbar_id_finderview_tag) || !getTag(R.id.moudle_zbar_id_finderview_tag).toString().startsWith("-")) {
            displacement += (mType == 1 ? 2f : 5f);
        }
        // 上移
        else {
